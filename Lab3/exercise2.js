...
function sendChat() {
    ...
    if (phrase.trim() !== "") {
        ...
        // INFO: change to relative path or absolute path depending on the server configuration
        //xhr.open("GET", "http://localhost:8080/chat.php?phrase=" + encodeURIComponent(phrase), true);
